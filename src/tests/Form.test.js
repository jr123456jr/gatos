...
describe('Pruebas en <Form/> contiene el label name',() => {
...
describe('Pruebas en <Form/> contiene el label age',() => {
...
describe('Pruebas en <Form/> contiene el label color',() => {
...
describe('Pruebas en <Form/> contiene el button submit',() => {
...
describe('Pruebas en <Form/> contiene el button reset',() => {
